...
telegraph = Telegraph()
page_ = telegraph.create_account(short_name="media info")



@friday_on_cmd(['mediainfo', 'mediadata', 'mi'],
               cmd_help={
...
async def get_mediainfo(client, message):
    ...
    km = response["path"]
    await m_.edit(f"**MediaInfo Can Be Found** [Here](https://telegra.ph/{km})")
